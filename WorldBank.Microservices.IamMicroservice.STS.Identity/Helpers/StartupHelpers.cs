...
using SendGrid;
using WorldBank.Microservices.IamMicroservice.Shared.Configuration.Email;
using WorldBank.Microservices.IamMicroservice.Shared.Email;
using WorldBank.Microservices.IamMicroservice.STS.Identity.Configuration;
using WorldBank.Microservices.IamMicroservice.STS.Identity.Configuration.ApplicationParts;
...
using WorldBank.Microservices.IamMicroservice.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace WorldBank.Microservices.IamMicroservice.STS.Identity.Helpers
{
